...
//    const goals = getFinalsCB.reduce(function(acc, item){
//     let homeGoals = item["Home Team Goals"];
//     let awayGoals = item["Away Team Goals"];
//     return acc + (homeGoals + awayGoals) / getFinalsCB.length;
// },0);
